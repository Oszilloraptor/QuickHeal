    ...
    if healType == "channel" then
        ...
        if not InCombat or TargetIsHealthy or maxRankFH<1 then
            ...
            if Health < QuickHealVariables.RatioFull then
                ...
                if healneed > (  84*shMod+healMod20*PF4) *k and ManaLeft >=  45*ihMod and maxRankLH >=2 and downRankNH >= 2  and SpellIDsLH[2] then SpellID = SpellIDsLH[2]; HealSize =   84*shMod+healMod20*PF4  end
                ...
                if healneed > ( 318*shMod+healMod30*PF18)*K and ManaLeft >= 155*ihMod and maxRankH  >=1 and downRankNH >= 4  and SpellIDsH[1]  then SpellID = SpellIDsH[1] ; HealSize =  318*shMod+healMod30*PF18 end
                if healneed > ( 460*shMod+healMod30)*K      and ManaLeft >= 205*ihMod and maxRankH  >=2 and downRankNH >= 5  and SpellIDsH[2]  then SpellID = SpellIDsH[2] ; HealSize =  460*shMod+healMod30      end
                if healneed > ( 604*shMod+healMod30)*K      and ManaLeft >= 255*ihMod and maxRankH  >=3 and downRankNH >= 6  and SpellIDsH[3]  then SpellID = SpellIDsH[3] ; HealSize =  604*shMod+healMod30      end
                if healneed > ( 758*shMod+healMod30)*K      and ManaLeft >= 305*ihMod and maxRankH  >=4 and downRankNH >= 7  and SpellIDsH[4]  then SpellID = SpellIDsH[4] ; HealSize =  758*shMod+healMod30      end
                if healneed > ( 956*shMod+healMod30)*K      and ManaLeft >= 370*ihMod and maxRankGH >=1 and downRankNH >= 8  and SpellIDsGH[1] then SpellID = SpellIDsGH[1]; HealSize =  956*shMod+healMod30      end
                if healneed > (1219*shMod+healMod30)*K      and ManaLeft >= 455*ihMod and maxRankGH >=2 and downRankNH >= 9  and SpellIDsGH[2] then SpellID = SpellIDsGH[2]; HealSize = 1219*shMod+healMod30      end
                if healneed > (1523*shMod+healMod30)*K      and ManaLeft >= 545*ihMod and maxRankGH >=3 and downRankNH >= 10 and SpellIDsGH[3] then SpellID = SpellIDsGH[3]; HealSize = 1523*shMod+healMod30      end
                if healneed > (1902*shMod+healMod30)*K      and ManaLeft >= 655*ihMod and maxRankGH >=4 and downRankNH >= 11 and SpellIDsGH[4] then SpellID = SpellIDsGH[4]; HealSize = 1902*shMod+healMod30      end
                if healneed > (2080*shMod+healMod30)*K      and ManaLeft >= 710*ihMod and maxRankGH >=5 and downRankNH >= 12 and SpellIDsGH[5] then SpellID = SpellIDsGH[5]; HealSize = 2080*shMod+healMod30      end
            end
        elseif not forceMaxHPS then
            ...
            if Health < QuickHealVariables.RatioFull then
                ...
                if healneed > (286*shMod+healMod15)*k and ManaLeft >= 155 and maxRankFH >=2 and downRankFH >= 2 and SpellIDsFH[2] then SpellID = SpellIDsFH[2]; HealSize = 286*shMod+healMod15 end
                if healneed > (360*shMod+healMod15)*k and ManaLeft >= 185 and maxRankFH >=3 and downRankFH >= 3 and SpellIDsFH[3] then SpellID = SpellIDsFH[3]; HealSize = 360*shMod+healMod15 end
                if healneed > (439*shMod+healMod15)*k and ManaLeft >= 215 and maxRankFH >=4 and downRankFH >= 4 and SpellIDsFH[4] then SpellID = SpellIDsFH[4]; HealSize = 439*shMod+healMod15 end
                if healneed > (567*shMod+healMod15)*k and ManaLeft >= 265 and maxRankFH >=5 and downRankFH >= 5 and SpellIDsFH[5] then SpellID = SpellIDsFH[5]; HealSize = 567*shMod+healMod15 end
                if healneed > (704*shMod+healMod15)*k and ManaLeft >= 315 and maxRankFH >=6 and downRankFH >= 6 and SpellIDsFH[6] then SpellID = SpellIDsFH[6]; HealSize = 704*shMod+healMod15 end
                if healneed > (885*shMod+healMod15)*k and ManaLeft >= 380 and maxRankFH >=7 and downRankFH >= 7 and SpellIDsFH[7] then SpellID = SpellIDsFH[7]; HealSize = 885*shMod+healMod15 end
            end
        elseif forceMaxHPS then
            if ManaLeft >= 155 and maxRankFH >=2 and downRankFH >= 2 and SpellIDsFH[2] then SpellID = SpellIDsFH[2]; HealSize = 286*shMod+healMod15 end
            if ManaLeft >= 185 and maxRankFH >=3 and downRankFH >= 3 and SpellIDsFH[3] then SpellID = SpellIDsFH[3]; HealSize = 360*shMod+healMod15 end
            if ManaLeft >= 215 and maxRankFH >=4 and downRankFH >= 4 and SpellIDsFH[4] then SpellID = SpellIDsFH[4]; HealSize = 439*shMod+healMod15 end
            if ManaLeft >= 265 and maxRankFH >=5 and downRankFH >= 5 and SpellIDsFH[5] then SpellID = SpellIDsFH[5]; HealSize = 567*shMod+healMod15 end
            if ManaLeft >= 315 and maxRankFH >=6 and downRankFH >= 6 and SpellIDsFH[6] then SpellID = SpellIDsFH[6]; HealSize = 704*shMod+healMod15 end
            if ManaLeft >= 380 and maxRankFH >=7 and downRankFH >= 7 and SpellIDsFH[7] then SpellID = SpellIDsFH[7]; HealSize = 885*shMod+healMod15 end
        end
    end
...
function QuickHeal_Priest_FindHoTSpellToUse(Target, healType, forceMaxRank)
    ...
    if healType == "hot" then
        ...
        if not forceMaxRank then
            ...
            if healneed > (315*shMod+healMod15)*k and ManaLeft >= 265 and maxRankR >=5  and SpellIDsR[5]  then SpellID = SpellIDsR[5]; HealSize = 315*shMod+healMod15 end
            if healneed > (400*shMod+healMod15)*k and ManaLeft >= 315 and maxRankR >=6  and SpellIDsR[6]  then SpellID = SpellIDsR[6]; HealSize = 400*shMod+healMod15 end
            if healneed > (510*shMod+healMod15)*k and ManaLeft >= 380 and maxRankR >=7  and SpellIDsR[7]  then SpellID = SpellIDsR[7]; HealSize = 510*shMod+healMod15 end
            if healneed > (650*shMod+healMod15)*k and ManaLeft >= 455 and maxRankR >=8  and SpellIDsR[8]  then SpellID = SpellIDsR[8]; HealSize = 650*shMod+healMod15 end
            if healneed > (810*shMod+healMod15)*k and ManaLeft >= 545 and maxRankR >=9  and SpellIDsR[9]  then SpellID = SpellIDsR[9]; HealSize = 810*shMod+healMod15 end
            if healneed > (970*shMod+healMod15)*k and ManaLeft >= 655 and maxRankR >=10 and SpellIDsR[10] then SpellID = SpellIDsR[10]; HealSize = 970*shMod+healMod15 end
        else
            ...
            if maxRankR >=5  and SpellIDsR[5]  then SpellID = SpellIDsR[5]; HealSize = 315*shMod+healMod15 end
            if maxRankR >=6  and SpellIDsR[6]  then SpellID = SpellIDsR[6]; HealSize = 400*shMod+healMod15 end
            if maxRankR >=7  and SpellIDsR[7]  then SpellID = SpellIDsR[7]; HealSize = 510*shMod+healMod15 end
            if maxRankR >=8  and SpellIDsR[8]  then SpellID = SpellIDsR[8]; HealSize = 650*shMod+healMod15 end
            if maxRankR >=9  and SpellIDsR[9]  then SpellID = SpellIDsR[9]; HealSize = 810*shMod+healMod15 end
            if maxRankR >=10 and SpellIDsR[10] then SpellID = SpellIDsR[10]; HealSize = 970*shMod+healMod15 end
        end
        --end
    end
...
function QuickHealSpellID(healneed)
    ...
    SpellID = SpellIDsLH[1]; HealSize = 53*shMod+healMod15*PF1; -- Default to LH
    if healneed > (  84*shMod+healMod20*PF4) *k and ManaLeft >=  45*ihMod and maxRankLH >=2 and SpellIDsLH[2] then SpellID = SpellIDsLH[2]; HealSize =   84*shMod+healMod20*PF4  end
    ...
    if healneed > ( 318*shMod+healMod30*PF18)*K and ManaLeft >= 155*ihMod and maxRankH  >=1 and SpellIDsH[1]  then SpellID = SpellIDsH[1] ; HealSize =  318*shMod+healMod30*PF18 end
    if healneed > ( 460*shMod+healMod30)*K      and ManaLeft >= 205*ihMod and maxRankH  >=2 and SpellIDsH[2]  then SpellID = SpellIDsH[2] ; HealSize =  460*shMod+healMod30      end
    if healneed > ( 604*shMod+healMod30)*K      and ManaLeft >= 255*ihMod and maxRankH  >=3 and SpellIDsH[3]  then SpellID = SpellIDsH[3] ; HealSize =  604*shMod+healMod30      end
    if healneed > ( 758*shMod+healMod30)*K      and ManaLeft >= 305*ihMod and maxRankH  >=4 and SpellIDsH[4]  then SpellID = SpellIDsH[4] ; HealSize =  758*shMod+healMod30      end
    if healneed > ( 956*shMod+healMod30)*K      and ManaLeft >= 370*ihMod and maxRankGH >=1 and SpellIDsGH[1] then SpellID = SpellIDsGH[1]; HealSize =  956*shMod+healMod30      end
    if healneed > (1219*shMod+healMod30)*K      and ManaLeft >= 455*ihMod and maxRankGH >=2 and SpellIDsGH[2] then SpellID = SpellIDsGH[2]; HealSize = 1219*shMod+healMod30      end
    if healneed > (1523*shMod+healMod30)*K      and ManaLeft >= 545*ihMod and maxRankGH >=3 and SpellIDsGH[3] then SpellID = SpellIDsGH[3]; HealSize = 1523*shMod+healMod30      end
    if healneed > (1902*shMod+healMod30)*K      and ManaLeft >= 655*ihMod and maxRankGH >=4 and SpellIDsGH[4] then SpellID = SpellIDsGH[4]; HealSize = 1902*shMod+healMod30      end
    if healneed > (2080*shMod+healMod30)*K      and ManaLeft >= 710*ihMod and maxRankGH >=5 and SpellIDsGH[5] then SpellID = SpellIDsGH[5]; HealSize = 2080*shMod+healMod30      end
